...
automl_run_id = 'automl_project_57'
...
def generate_algorithm_config_1():
    ...
    algorithm = GradientBoostingRegressor(
        ...
        min_samples_split=0.44274518434944915,
        min_weight_fraction_leaf=0.0,
        n_estimators=600,
...
def generate_algorithm_config():
    ...
    algorithm = PreFittedSoftVotingRegressor(
        ...
        weights=[0.06666666666666667, 0.06666666666666667, 0.06666666666666667, 0.06666666666666667, 0.06666666666666667, 0.13333333333333333, 0.26666666666666666, 0.2, 0.06666666666666667]
    )
...
if __name__ == '__main__':
    ...
    parser.add_argument('--training_dataset_uri', type=str, default='azureml://locations/eastus/workspaces/5671b9e1-8a31-463c-9782-140e28816486/data/archives/versions/1',     help='Default training dataset uri is populated from the parent run')
